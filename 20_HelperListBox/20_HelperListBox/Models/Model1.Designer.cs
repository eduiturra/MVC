...
namespace _20_HelperListBox.Models
{
    ...
    /// </summary>
    public partial class SampleModel : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new SampleModel object using the connection string found in the 'SampleModel' section of the application configuration file.
        /// </summary>
        public SampleModel() : base("name=SampleModel", "SampleModel")
        {
        ...
        /// <summary>
        /// Initialize a new SampleModel object.
        /// </summary>
        public SampleModel(string connectionString) : base(connectionString, "SampleModel")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new SampleModel object.
        /// </summary>
        public SampleModel(EntityConnection connection) : base(connection, "SampleModel")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CityModel", Name="City")]
    [Serializable()]
