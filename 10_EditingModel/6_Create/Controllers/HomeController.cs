...
namespace _6_Create.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            _6_Create.Models.Context con = new Context();
            Departament Result = con.Departamentos.SingleOrDefault(a => a.ID == id);
            TryUpdateModel(Result,new String[]{"name"});//Se puede especificar que datos modificar
            ///TryUpdateModel(Result,null,(aca para incluir),(aca para excluir));
            if (ModelState.IsValid)
            {
